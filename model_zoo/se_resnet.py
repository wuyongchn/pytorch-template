...
model_urls = {
    'se_resnet18': 'https://download.pytorch.org/models/se_resnet18.pth',
    'se_resnet34': 'https://download.pytorch.org/models/se_resnet34.pth',
    ...
    'se_resnet152': 'https://download.pytorch.org/models/resnet152-b121ed2d.pth',
}
...
def se_resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['se_resnet18']))
